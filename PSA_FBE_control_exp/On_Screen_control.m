    ...
    while session <= info.ntrials 
        ...
        if trl.onset_blocks(session,1) == 1
            ...
            if info.matrix(session,2) == 1
                ex_img = imread('/home/kaneda/Documents/GitHub/PSA_FBA_control_exp/Images/target_CW.png');
            else
                ex_img = imread('/home/kaneda/Documents/GitHub/PSA_FBA_control_exp/Images/target_CCW.png');
            end
        ...
        Eyelink('Command', 'clear_screen 0');       % Clear Host PC display from any previus drawing
        Eyelink('ImageTransfer', '/home/kaneda/Documents/GitHub/PSA_FBA_control_exp/Images/trl_on.bmp', 0, 0, 0, 0, 0, 0);
        ...
        for trial = 1:trl.wnoise_off(session,1)+24 % 24 % TRIAL WILL END 200 MS AFTER TARG OFF (mask off)
            ...
            %         imwrite(current_display, 'targ_right.png');
            %     else
            %         current_display = Screen('GetImage',win);
            %         imwrite(current_display, 'targ_left.png');
            %     end
            % end
        ...
        % Colect answer for each trial.
            resp(session,1) = targ_ori;


            if (session >= 1 && session <= 60) || (session >= 421 && session <= 480)

                if resp(session,1) == info.matrix(session,5)
                    fp = imread('/home/kaneda/Documents/GitHub/PSA_FBA_control_exp/Images/gfp.png');
                else
                    fp = imread('/home/kaneda/Documents/GitHub/PSA_FBA_control_exp/Images/rfp.png');
                end
        ...
        if  SRT2 > 0.3  % || FIX == 3
            ...
            ofp = imread('/home/kaneda/Documents/GitHub/PSA_FBA_control_exp/Images/ofp.jpg');
