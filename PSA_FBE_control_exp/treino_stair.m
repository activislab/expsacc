path = '/home/kaneda/Documents/GitHub/PSA_FBA_control_exp/Images/img_stair_treino';
...
Rtarg_CW = imread(sprintf('targ_right.png'));
tex_Rtarg_CW = Screen('MakeTexture', win, Rtarg_CW);

Rtarg_CCW = imread(sprintf('Rtarg_CW.png'));
