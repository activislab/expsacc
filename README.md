...
*To plot d' results, you'll need the bagplot function. We implemented a custom version of the original code (https://github.com/mwgeurts/libra/tree/master), which can be found in the "libra-master" folder.*
